...
## Second Impression:
Carthage supports building .frameworks from source .swift files. but it's difficult to figure out how to do this at first. The Carthage project doesn't have wiki sections or tutorials so you are left digging in old github issues / stackoverlfow questions / forums. If your lucky enough to have the luxury of time to figure it all out the process isn't elegant. 
